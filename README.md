...
1. Добавляем ваши данные в `.env` и `.env-non-dev`(в нем DB_HOST не трогаем!)
2. Для запуска без тестов вводим

   > `docker-compose -f docker-compose.yml up --build`

3. Перейдите по ссылке(в конце пропишите `/docs`) в терминале IDE либо в браузере `{ваш ipV4}:{ваш port}/docs`

4. Для запуска с тестами вводим в терминал 
